...
private:
  ...
  void getTmpEnd(Eigen::Vector3d& tmpEnd, DynamicVoronoi voronoiDiagram, Eigen::Vector3d start, Eigen::Vector3d end);
  bool reachHorizon(Eigen::Vector3d point, DynamicVoronoi voronoi);
public:
  KinoReplanFSM(/* args */) {
  }
  ~KinoReplanFSM() {
