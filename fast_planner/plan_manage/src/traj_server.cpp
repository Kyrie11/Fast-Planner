...
ros::Publisher cmd_vis_pub, pos_cmd_pub, traj_pub, rotors_cmd_pub;
...
void cmdCallback(const ros::TimerEvent& e) {
  ...
  rotors_cmd.pose.position = cmd.position;
  rotors_cmd.pose.position.z += 1.0;
...
int main(int argc, char** argv) {
  ...
  rotors_cmd_pub = node.advertise<geometry_msgs::PoseStamped>("/ardrone/command/pose", 50);
